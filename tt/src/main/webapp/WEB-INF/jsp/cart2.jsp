...
<body>
			...
			<div class="table-responsive cart_info">
				<table class="table table-condensed">
					<thead>
						<tr class="cart_menu">
							<td class="image"></td>
							<td class="description"><spring:message code="description2"/></td>
							<td class="price"><spring:message code="price"/></td>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright ÃÂ© 2013 E-SHOPPER Inc. All rights reserved.</p>
