		...
		<div class="container">
			<div class="row">
				...
				<div id="1" class="col-sm-9 padding-right">
					...
					<p><b>в <a href="our_shops">магазинах</a> ОАО Трикотажторг с предоставлениям покупателям скидки с розничной цены товара в размере 15%.</b></p>
				...
				<div id="2" class="col-sm-9 padding-right">
					...
					<p><b>С 04.04.2017  по 30.04.2017 проводится  расширенная  распродажа товаров в <a href="our_shops">магазинах</a> «Трикотаж» №1,2,3,4,5.</b></p>
					<ul>
