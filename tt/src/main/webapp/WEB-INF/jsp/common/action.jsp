		...
		<div class="container">
			<div class="row">
				...
				<div id="1" class="col-sm-9 padding-right">
					...
					<h2>&nbsp</h2>
					<p>Данная акция не распространяется на товары, реализуемые по другим акциям, а также на товары на которые установлена торговая надбавка в размере 15% и меньше.</p>
					<h2>&nbsp</h2>
					<!-- content -->
				</div>
				...
				<div id="2" class="col-sm-9 padding-right">
					<!-- content -->
					<h2>Акция "Расширенная распродажа"</h2> 
					<p><b>С 04.04.2017  по 30.04.2017 провести расширенную распродажу товаров в магазинах «Трикотаж» №1,2,3,4,5.</b></p>
					<ul>
						<p>На период проведения  распродажи установить скидку с розничной цены на товары, участвующие в акции:</p>
						<li>-  в размере 25%  на товары для взрослых</li>
						<li>-  в размере 20%  на товары для детей и подростков</li>
					</ul>
					<h2>&nbsp</h2>
					<p>Данная акция не распространяется на товары, реализуемые по другим акциям, а  также товары, на которые установлена торговая надбавка в размере 15% и меньше.</p>
					<h2>&nbsp</h2>
					<!-- content -->
				</div>
